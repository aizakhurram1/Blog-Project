            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded-md">
                    ...
                    @if (!$paginator->onFirstPage())
                          ...
                          <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 text-sm flex items-center justify-center mr-3" aria-label="{{ __('pagination.next') }}">
